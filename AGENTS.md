...
│   └── sessions/     — Файлы сессий Telethon, не трогать
├── tests/            ← Тесты
└── run.py            ← Точка входа
```
...
- `SESSION_NAME` по умолчанию: `84523248603`;
- не пересоздавать и не удалять `data/sessions/84523248603.session`.
...
| Путь                                | Описание                         |
|-------------------------------------|----------------------------------|
| `data/sessions/84523248603.session` | Существующая Telethon-сессия     |
...
- Не трогай пользовательские данные и существующую Telethon-сессию.
